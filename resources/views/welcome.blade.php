...
<div id="outer">
    <div id="outer-canvas"> <!-- Navbar -->
        <header>
            ...
            <!-- Back to top -->
            <div class="back-to-top"><span class="arrow-xs"><img src="images/icon-scroll-arrow.png" alt=""></span><img src="images/icon-scroll-mouse.png" alt=""></div>
            <!-- //end Back to top -->
            ...
            <section class="navbar">
                <div class="background">
                    <div class="container">
                        <!-- Logo -->
                        <div class="navbar-logo pull-left"> <a href="{{url('')}}"><img src="images/liveradio/logo-dark.gif" alt="" class="img-responsive"></a></div>
                        <!-- //end Logo -->
                        <div id="top-player">
        ...
        #################################
        -->
            <div class="tp-banner-container hidden-xs-up">
                <div class="tp-banner">
                    <ul>
                        <!-- SLIDE  -->
                        <li data-transition="slotzoom-horizontal" data-slotamount="10" data-masterspeed="500" data-saveperformance="on"  data-title="Slide1">
                            ...
                            <div class="tp-caption text1 sfr"
                                 ...
                                 data-endspeed="300"
                                 style="z-index: 1; max-width: auto; max-height: auto; white-space: nowrap;"><span>LA MEJOR</span></div>
                            ...
                            <div class="tp-caption text2 sfr"
                                 ...
                                 data-endelementdelay="0.1"
                                 data-endspeed="300"
                                 style="z-index: 2; max-width: auto; max-height: auto; white-space: nowrap;"><span>Musica</span></div>
        ...
        <section class="container content-row">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-4 animate fadeInRight">
                    <h2><span class="icon flaticon-movie29 color"></span>TV EN VIVO</h2>
        ...
        <!-- //end Blog widget -->
        <li data-transition="slotzoom-horizontal" data-slotamount="10" data-masterspeed="500" data-saveperformance="on"  data-title="Slide1"></li>
        <!-- Social navbar -->
