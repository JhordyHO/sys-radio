...
<div id="outer">
    <div id="outer-canvas"> <!-- Navbar -->
        ...
        <!-- Breadcrumbs -->
        <div id="breadcrumbs">
            <div class="container"><a href="{{url('')}}">Inicio</a> <span>&#8250;</span>Programación</div>
        </div>
        <!-- //end Breadcrumbs -->
        ...
        <section class="content">
            <div class="container">
                <h1>NUESTRA PROGRAMACION</h1>
                <div role="tabpanel">

                    <!-- Nav tabs -->
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#tab1" role="tab" data-toggle="tab" id="tabLink-1">Lunes</a></li>
                        <li role="presentation"><a href="#tab2" role="tab" data-toggle="tab" id="tabLink-2">Martes</a></li>
                        <li role="presentation"><a href="#tab3" role="tab" data-toggle="tab" id="tabLink-3">Miércoles</a></li>
                        <li role="presentation"><a href="#tab4" role="tab" data-toggle="tab" id="tabLink-4">Jueves</a></li>
                        <li role="presentation"><a href="#tab5" role="tab" data-toggle="tab" id="tabLink-5">Viernes</a></li>
