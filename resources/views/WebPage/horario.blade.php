                ...
                <div class="background">
                    <div class="container">
                        ...
                        <dl class="navbar-main-menu hidden-xs">
                            <dt class="item"> <a href="index-2.html" class="btn-main"><span class="icon flaticon-home"></span></a> </dt>
                            <dd></dd>
                            <dt class="item">
                            <ul class="sf-menu">
                                <li> <a href="djs.html">Djs</a>
                                    <ul>
                            ...
                            <dd></dd>
                            <dt class="item"> <a href="schedule.html" class="btn-main active">Schedule</a> </dt>
                            <dd></dd>
                            <dt class="item"> <a href="blog-posts.html" class="btn-main">BLOG</a> </dt>
                            <dd></dd>
                            <dt class="item"> <a href="galeria.html" class="btn-main">GALLERY</a> </dt>
                            <dd></dd>
                            <dt class="item"> <a href="faq.html" class="btn-main">FAQ</a> </dt>
                            <dd></dd>
                            <dt class="item"> <a href="contacto.html" class="btn-main">Contact</a> </dt>
                            <dd></dd>
                        </dl>
                        <!-- //end Main menu -->
